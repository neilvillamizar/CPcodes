...
Convex Hull Trick dinamico (caja negra);

 No es necesario que las pendientes o abscisas esten ordenadas.

 para usar: declaracion: hull_optimizer myhull;
            inserts:     myhull.add_line(m, b); // m:pendiente, b:interseccion con eje y; ambos ll.
            querys:      h.query(x);            // retorna ll; x:abscisa; tambien ll. 
